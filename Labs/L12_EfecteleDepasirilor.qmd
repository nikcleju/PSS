...
1. Utilizați utilitarul `fdatool` pentru a proiecta un filtru trece-jos IIR
   ...
   b. Exportați filtrul în Simulink în forma cu secțiuni de ordinul 2 ("Export to Simulink model", bifați *Build model using basic elements*).
   a. Convertiți filtrul la forma directă II și exportați-l din nou în Simulink (bifați *Build model using basic elements*).
...
3. Repetați exercițiul 2 pentru filtrele implementate cu secțiuni de ordinul 2.
