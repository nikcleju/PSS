...
2. În modelul Simulink, realizați două copii ale filtrului (Copy/Paste) în forma directă 2.
   ...
   La blocul "From Multimedia File", setați parametrul "Samples per audio channel" (1024) la **1**.
   ...
   b. Creșteți numărul de biți de la partea întreagă, pentru a obține un semnal de ieșire asemănător celui original;
   c. Obțineți și afișați diferența dintre cele două ieșiri;
   d. Exportați semnalul diferență dintre cele două ieșiri în Workspace-ul Matlab și calculați media și varianța sa.
   
      Folosiți un bloc "To Workspace", cu setările: 
	  - Save format: Array
	  - 2D în loc de 3D

3. Repetați exercițiul 2 pentru filtrul implementat cu secțiuni de ordinul 2.
